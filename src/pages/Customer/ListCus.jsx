...
const ListCus = ({navigation}) => {
    const [customers, setCustomers] = useState([]); // States để lưu trữ dữ liệu khách hàng
    const [searchQuery, setSearchQuery] = useState(''); // States để lưu trữ từ khóa tìm kiếm
